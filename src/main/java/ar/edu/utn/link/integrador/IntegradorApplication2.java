...
//
//		Producto smartTv = new Producto("SmartTV", 20000);
//		Producto notebook = new Producto("Notebook Dell", 50000);
//		Producto calculadora = new Producto("Calculadora", 500);
//		Producto reloj = new Producto("SmartWatch", 500);
//
